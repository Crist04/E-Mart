...
//     BTAppContextSwitcher.setReturnURLScheme("com.baclinc.ecomproject.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.baclinc.ecomproject.braintree") == .orderedSame {
